...
ckpt = torch.load('cfg/training/training-vod.pt', map_location=device)
# reparameterized model in cfg/deploy/*.yaml
model = Model('cfg/deploy/vod.yaml', ch=3, nc=2).to(device)

with open('cfg/deploy/vod.yaml') as f:
...
torch.save(ckpt, 'cfg/deploy/vod.pt')
